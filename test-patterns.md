...
|------|----------|--------------|
| `~/.claude/test-patterns-catalog.md` | G-1 -- G-40, G-51 -- G-58, P-1 -- P-46, P-53 -- P-57, P-62 -- P-67 (general + E2E) | Always — grep matched pattern IDs |
| `~/.claude/test-patterns-redux.md` | G-41 -- G-45, P-40, P-41, P-44 | Code type includes REDUX-SLICE |
| `~/.claude/test-patterns-nestjs.md` | G-33, G-34, NestJS-G1, NestJS-G2, NestJS-AP1, NestJS-P1–P3, security S1–S7, templates | Code type includes CONTROLLER + NestJS stack |
