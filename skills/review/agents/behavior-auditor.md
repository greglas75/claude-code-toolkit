...
**Code Quality Framework:** Reference `~/.claude/rules/code-quality.md` for CQ1-CQ20 checklist. Your steps cover CQ3-10 (validation, security, resources, errors, data integrity), CQ15 (async safety), CQ16 (financial precision), CQ18 (cross-system data consistency), CQ19 (data contracts). Flag CQ violations as issues with severity mapped: CQ critical gate (CQ3/4/5/6/8/14) → CRITICAL, others → HIGH/MEDIUM.
