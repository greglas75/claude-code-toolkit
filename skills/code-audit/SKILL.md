...
Split files into batches of 6-8. For each batch, spawn a Task agent (subagent_type: "general-purpose") with this prompt:
...
N/A HANDLING: See ~/.claude/rules/code-quality.md for strict N/A rules.
...
- If project has no CLAUDE.md, use defaults from `~/.claude/rules/file-limits.md`
