...
> **Usage:** Read on-demand by `/review` command. Core rules in `~/.codex/skills/review/rules.md` (read by skill on invocation).
...
- [ ] No God components/functions (>250 lines = smell, see `~/.codex/rules/file-limits.md`)
