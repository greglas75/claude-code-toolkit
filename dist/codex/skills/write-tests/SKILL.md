...
4. [x]/[ ]  references/quality-rules.md    -- edge cases, mock safety, self-eval evidence, auto-fail patterns
```
...
2. **If file doesn't exist**: create it from `references/coverage-template.md` (template + column definitions).
