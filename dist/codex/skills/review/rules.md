...
For large reviews, `/review` splits audit steps across 2 custom agents in parallel. Agents are defined in `references/` with enforced read-only tool access (no Write/Edit) and optimized model routing.
