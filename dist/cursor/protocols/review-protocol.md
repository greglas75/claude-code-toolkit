...
> **Usage:** Read on-demand by `/review` command. Core rules in `~/.cursor/skills/review/rules.md` (read by skill on invocation).
...
- [ ] No God components/functions (>250 lines = smell, see `~/.cursor/rules/file-limits.md`)
