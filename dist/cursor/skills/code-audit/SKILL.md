...
```
1. ✅/❌  ~/.cursor/rules/code-quality.md         — CQ1-CQ20 checklist, scoring, evidence, N/A rules, examples
2. ✅/❌  ~/.cursor/rules/security.md             — SSRF, XSS, auth, path traversal patterns
3. ✅/❌  ~/.cursor/rules/file-limits.md          — 250-line file limit, 50-line function limit
```
