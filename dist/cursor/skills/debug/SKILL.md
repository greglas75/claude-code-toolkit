...
```
1. [x]/[ ]  ~/.cursor/rules/testing.md         -- Q1-Q17 self-eval for regression test (Phase 4.5)
2. [x]/[ ]  ~/.cursor/rules/code-quality.md    -- CQ1-CQ20 self-eval for production fix (Phase 4.6)
```
...
Run Q1-Q17 self-eval (from `~/.cursor/rules/testing.md`) on the regression test:
...
Run CQ1-CQ20 (from `~/.cursor/rules/code-quality.md`) on each modified production file:
