...
**Backlog location:** `memory/backlog.md` in the project's auto memory directory (path shown in system prompt). If the file doesn't exist, create it from the template in `~/.cursor/skills/review/rules.md`.
