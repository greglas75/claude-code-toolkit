...
1. **Read** project CLAUDE.md + `~/.antigravity/rules/code-quality.md` for CQ1-CQ20 checklist
...
Read ~/.antigravity/rules/code-quality.md -- CQ1-CQ20 full checklist with evidence + N/A rules
```
