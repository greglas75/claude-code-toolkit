...
```
1. [x]/[ ]  ~/.antigravity/rules/code-quality.md         -- CQ1-CQ20 checklist, scoring, evidence, N/A rules, examples
2. [x]/[ ]  ~/.antigravity/rules/security.md             -- SSRF, XSS, auth, path traversal patterns
3. [x]/[ ]  ~/.antigravity/rules/file-limits.md          -- 250-line file limit, 50-line function limit
```
...
- `~/.antigravity/rules/` -> `_agent/rules/`
...
N/A HANDLING: See ~/.antigravity/rules/code-quality.md for strict N/A rules.
...
2. **If file doesn't exist**: create it with this template (or use the one in `~/.antigravity/skills/review/rules.md` if available):
   ```markdown
   # Tech Debt Backlog
