...
```
1. [x]/[ ]  ~/.antigravity/rules/testing.md         -- Q1-Q17 self-eval for regression test (Phase 4.5)
2. [x]/[ ]  ~/.antigravity/rules/code-quality.md    -- CQ1-CQ20 self-eval for production fix (Phase 4.6)
```
...
Run Q1-Q17 self-eval (from `~/.antigravity/rules/testing.md`) on the regression test:
...
Run CQ1-CQ20 (from `~/.antigravity/rules/code-quality.md`) on each modified production file:
