...
Analysis to perform (execute inline):
  prompt: |
    You are a Coverage Scanner. Read ~/.antigravity/skills/write-tests/agents/coverage-scanner.md
...
Analysis to perform (execute inline):
  prompt: |
    You are a Pattern Selector. Read ~/.antigravity/skills/write-tests/agents/pattern-selector.md
    for full instructions.
...
Analysis to perform (execute inline):
  prompt: |
    You are a Test Quality Auditor. Read ~/.antigravity/skills/write-tests/agents/test-quality-auditor.md
    for full instructions.
