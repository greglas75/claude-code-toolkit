...
```
1. [x]/[ ]  ~/.antigravity/rules/code-quality.md         -- CQ1-CQ20 (this audit extends CQ3/5/7/16/19/20)
2. [x]/[ ]  ~/.antigravity/rules/security.md             -- SSRF, path traversal, auth patterns
...
## Phase 1 Execution: Per-Controller/Module Evaluation

For each controller/module, evaluate against D1-D10 using the instructions in `agent-prompt.md`. Each evaluation covers one controller/module and all its endpoints.
