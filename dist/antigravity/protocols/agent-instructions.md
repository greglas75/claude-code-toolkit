...
All `_agent/` paths are symlinks. If a skill references `~/.antigravity/`, resolve as:
- `~/.antigravity/rules/` -> `_agent/rules/`
- `~/.antigravity/skills/` -> `_agent/skills/`
- `~/.antigravity/review-protocol.md` -> `_agent/review-protocol.md`
- `~/.antigravity/test-patterns.md` -> `_agent/test-patterns.md`
- `~/.antigravity/test-patterns-catalog.md` -> `_agent/test-patterns-catalog.md`
- `~/.antigravity/test-patterns-redux.md` -> `_agent/test-patterns-redux.md`
- `~/.antigravity/test-patterns-nestjs.md` -> `_agent/test-patterns-nestjs.md`
- `~/.antigravity/test-patterns-yii2.md` -> `_agent/test-patterns-yii2.md`
