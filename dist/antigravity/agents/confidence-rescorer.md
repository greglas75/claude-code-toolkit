...
- Issue is stylistic preference without explicit project convention in `.antigravity/rules/`
...
**Score UP (+10-20) when:**
- Issue matches a rule in `.antigravity/rules/*.md` or project's CLAUDE.md
