...
**IMPORTANT:** Read the project's `CLAUDE.md` and `.antigravity/rules/` directory at the start to learn project-specific testing conventions (test runner, test file locations, coverage requirements).
...
6. **Read project rules** -- check CLAUDE.md and `.antigravity/rules/` for project-specific test conventions.
