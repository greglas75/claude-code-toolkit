...
**IMPORTANT:** Read the project's `CLAUDE.md` and `.antigravity/rules/` directory at the start to learn project-specific test file location conventions.
...
3. **Read project rules** -- check CLAUDE.md and `.antigravity/rules/` for project-specific test conventions.
