...
**IMPORTANT:** Read the project's `CLAUDE.md` and `.antigravity/rules/` directory at the start to learn project-specific file limits and organization conventions.
...
4. **Read project rules** -- check CLAUDE.md and `.antigravity/rules/` for project-specific file limits and conventions.
